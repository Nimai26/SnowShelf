...
**Compétition** — Bandai organise des tournois officiels, des Regional Championships et des Digimon Card Game World Championships. Le jeu a su se créer une communauté fidèle et compétitive.`,
      ...
      },
      {
        name: 'Fabuland',
        slug: 'fabuland',
        description: "Gamme LEGO Fabuland (1979-1989) mettant en scène des personnages animaux anthropomorphes dans un univers coloré et enfantin. Destinée aux 3-7 ans, la série proposait des sets de construction simplifiés avec des personnages comme Edward Elephant, Bonnie Bunny, Cornelius Cat ou Hannah Hippopotamus. Les bâtiments (mairie, école, hôpital, commerces) formaient un village complet. Fabuland a aussi eu une série animée (Edward and Friends). Très appréciée pour son charme rétro, la gamme compte environ 100 sets et reste recherchée par les collectionneurs LEGO vintage.",
        icon: '📁',
        color: '#f39c12',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Dino-Riders',
        slug: 'dino-riders',
        description: "Franchise Tyco (1988-1990) combinant dinosaures préhistoriques et technologie futuriste. Les Valoriens, humains pacifiques, affrontent les Rulons, extraterrestres malfaisants, en chevauchant des dinosaures équipés d'armures et d'armes. La gamme comprend des figurines articulées et des dinosaures de tailles variées (du Deinonychus au gigantesque Brontosaurus). La série animée de 14 épisodes (Marvel Productions) accompagnait les jouets. Les dinosaures Dino-Riders ont été réédités par le Smithsonian Institution sans les armures. Gamme courte mais culte, très prisée des collectionneurs.",
        icon: '📁',
        color: '#27ae60',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'MASK',
        slug: 'mask',
        description: "Mobile Armored Strike Kommand (1985-1988) : franchise Kenner avec des véhicules se transformant en machines de combat. Matt Trakker et son équipe MASK affrontent VENOM (Vicious Evil Network of Mayhem) dirigé par Miles Mayhem. Chaque personnage porte un masque aux pouvoirs spéciaux. Véhicules emblématiques : Thunderhawk (Camaro/avion), Rhino (camion/base mobile), Condor (moto/hélicoptère). La série animée DIC (75 épisodes) et le comic DC accompagnaient les jouets. Deux séries de jouets : Racing (1986) et Split Seconds (1988).",
        icon: '📁',
        color: '#2980b9',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Battle Beasts',
        slug: 'battle-beasts',
        description: "Figurines Hasbro/Takara (1987-1989) représentant des guerriers anthropomorphes avec un système de combat pierre-feuille-ciseaux holographique. Chaque figurine (environ 5 cm) est un animal en armure avec un symbole caché sur le torse : eau, feu ou bois. Trois séries ont été produites avec plus de 76 figurines. La série japonaise Beastformers de Takara incluait des figurines exclusives et un manga. Les Laser Beasts (série 4) ajoutaient des cristaux Orb. Très collectionnées pour leur concept unique et leur format compact.",
        icon: '📁',
        color: '#e74c3c',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'SilverHawks',
        slug: 'silverhawks',
        description: "Série animée et gamme de jouets Kenner (1986-1988) suivant des héros partiellement métalliques combattant Mon*Star dans la galaxie de Limbo. Créée par Rankin/Bass (même équipe que les Cosmocats), la série compte 65 épisodes. Les figurines articulées possédaient des ailes déployables et des accessoires chromés. Personnages principaux : Quicksilver, Bluegrass, Steelheart, Steelwill, Copper Kidd. Le vaisseau Miraj et le Maraj de Mon*Star sont les véhicules emblématiques. Gamme courte mais très appréciée des collectionneurs 80s.",
        icon: '📁',
        color: '#95a5a6',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Cosmocats',
        slug: 'cosmocats',
        description: "ThunderCats (1985-1989) : franchise LJN/Bandai suivant les aventures de Lion-O et des Cosmocats sur la Troisième Terre contre Mumm-Ra. La série animée Rankin/Bass (130 épisodes) est devenue culte. La gamme LJN proposait des figurines articulées avec la fonction Battle-Matic (yeux lumineux) et des accessoires comme l'Épée de Justice (Sword of Omens). Le Repaire des Cosmocats (Cat's Lair) et le véhicule ThunderTank sont les playsets les plus recherchés. Personnages iconiques : Lion-O, Tigro, Panthéra, Guépard, Starlion, Félibelle.",
        icon: '📁',
        color: '#e67e22',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Star Wars',
        slug: 'star-wars',
        description: "Franchise de figurines, véhicules et accessoires Star Wars de Kenner puis Hasbro. Depuis 1978, des milliers de figurines articulées (3¾ pouces puis 6 pouces Black Series) couvrent toutes les trilogies et séries. Les figurines vintage Kenner (1978-1985) sont parmi les jouets les plus collectionnés au monde, avec des pièces rares comme le Boba Fett rocket-firing ou le vinyl-cape Jawa atteignant des milliers d'euros. Les gammes Power of the Force, Saga, Clone Wars et Vintage Collection perpétuent la tradition. Véhicules emblématiques : Millennium Falcon, AT-AT, X-Wing, TIE Fighter.",
        icon: '📁',
        color: '#2c3e50',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Jurassic Park',
        slug: 'jurassic-park',
        description: "Gamme de jouets Kenner (1993-2001) inspirée de la franchise cinématographique de Steven Spielberg. La première série (1993) accompagnait le film original avec des dinosaures réalistes et des figurines humaines. Innovations : dinosaures avec Dino-Damage (peau arrachable révélant les blessures) et capture gear. Les séries Lost World (1997) et JP3 (2001) ont étendu la gamme. Hasbro a relancé avec Jurassic World (2015+). Les jouets vintage 1993 en boîte, notamment le T-Rex et le Compound, sont très recherchés par les collectionneurs.",
        icon: '📁',
        color: '#1abc9c',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Power Lords',
        slug: 'power-lords',
        description: "Gamme de figurines Revell (1983-1984) créée par Wayne Barlowe, célèbre artiste de science-fiction. Adam Power, le dernier Power Lord, protège la planète Domus de l'Empire de la Terreur d'Arkus. Les figurines se distinguent par leur design alien unique et détaillé, loin des canons héroïques habituels. Personnages : Adam Power (avec transformation), Shaya, Sydot, Tork, Ggripptogg, Raygoth, Drrench. Malgré une durée de vie très courte et l'absence de série TV, les Power Lords sont devenus des objets de collection prisés pour leur originalité artistique. The Four Horsemen ont relancé la licence en 2013.",
        icon: '📁',
        color: '#8e44ad',
        isDefault: true,
        isPublic: true,
      ...
      },
      {
        name: 'Playmobil',
        slug: 'playmobil',
        description: "Système de jeu Geobra Brandstätter depuis 1974, créé par Hans Beck. Les figurines Playmobil (7,5 cm) au sourire caractéristique évoluent dans des univers thématiques : chevaliers, pirates, western, pompiers, police, hôpital, ferme, cirque, espace, egypte. Le Klicky (figurine de base) est devenu une icône du jouet allemand. Les sets vintage des années 1970-80 (château médiéval 3666, bateau pirate 3550, western fort 3419) sont très prisés. Playmobil a aussi des gammes spéciales : collectors, liées à des licences (Naruto, Astérix, Star Trek) et des dioramas pour adultes. Plus de 3 milliards de figurines produites depuis 1974.",
        icon: '📁',
        color: '#3498db',
        isDefault: true,
        isPublic: true,

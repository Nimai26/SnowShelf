...
return [
    ...
    'admin' => [
        ...
        'api_alias' => 'Alias (sous-providers)',
        'api_alias_hint' => 'Liste des sous-providers séparés par des virgules (ex: deezer,discogs,spotify pour music)',
        ...
        // Whitelist Proxy
        'tab_proxy_whitelist' => 'Whitelist Proxy',
        'proxy_whitelist_title' => 'Domaines Autorisés (Proxy)',
        'proxy_whitelist_desc' => 'Gérez les domaines autorisés pour le téléchargement d\'images et de fichiers via le proxy. Un domaine par ligne.',
        'proxy_category_images' => 'Images',
        'proxy_category_audio' => 'Audio',
        'proxy_category_documents' => 'Documents',
        'proxy_category_general' => 'Général',
        'proxy_domains_count' => '%d domaine(s)',
        'proxy_domains_placeholder' => 'Un domaine par ligne...\nExemple:\nexample.com\ncdn.example.com\napi.example.org',
        'proxy_whitelist_saved' => 'Whitelist mise à jour avec succès',
        'proxy_whitelist_error' => 'Erreur lors de la mise à jour',
        'proxy_add_domain' => 'Ajouter un domaine',
        'proxy_domain_field' => 'Domaine',
        'proxy_domain_hint' => 'Ex: api.example.com ou example.com',
        'proxy_category_field' => 'Catégorie',
        'proxy_description_field' => 'Description',
        'proxy_description_hint' => 'Description optionnelle du domaine',
        'proxy_domain_added' => 'Domaine ajouté avec succès',
        'proxy_domain_updated' => 'Domaine mis à jour',
        'proxy_domain_deleted' => 'Domaine supprimé',
        'proxy_domain_exists' => 'Ce domaine existe déjà dans cette catégorie',
    ...
    'web_search' => [
        ...
        'detail_refresh_title' => 'Recharger les détails depuis l\'API',
        'detail_from_cache' => 'Données en cache - Cliquez pour actualiser',
